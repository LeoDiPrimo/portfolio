/**
 * Inline SVG icons. Kept inline (instead of a sprite in `public/`) so they go
 * through the bundler and inherit `currentColor`.
 *
...
export function LinkedInIcon() {
  return (
    <svg {...BASE_PROPS} fill="currentColor">
...
export function LeafIcon() {
  return (
    ...
    >
      ...
      <path d="M2 21a5 5 0 0 0 2.911-4.544C7.613 15.212 8.351 15.24 11 13" />
    </svg>
  )
}
